...
for file_name in file_name_list:
    ...
    city_df = pd.read_csv(os.path.join(folder_path, file_name), header=0, index_col=0)
...
for file_name in file_name_list:
    ...
    # Load data into Pandas DataFrame with first row as column names and first column as index names.
    temp_df = pd.read_csv(os.path.join(folder_path, file_name), header=0, index_col=0)
    # Remove pre-generated average columns.
